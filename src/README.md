...
- **domains/** — 跨语言领域指南。从物理现实理解 Web 架构全貌：代码跑在哪、前后端如何通信、部署的完整流程
...
└── domains/                             # 跨语言领域指南
        ├── web-architecture.md              # Web 架构通识：从 URL 到页面显示的完整物理路径
...
**理解 Web 架构的物理现实**：先读 `domains/web-architecture.md`——理解代码跑在哪、怎么连接、怎么从编辑器到用户屏幕。
